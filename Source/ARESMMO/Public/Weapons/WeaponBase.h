...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	UStaticMeshComponent* MeshGrip = nullptr;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	UStaticMeshComponent* MeshScope = nullptr;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	UStaticMeshComponent* MeshMuzzle = nullptr;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	UStaticMeshComponent* MeshMag = nullptr;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	UStaticMeshComponent* MeshLaser = nullptr;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	UStaticMeshComponent* MeshFlashlight = nullptr;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	UStaticMeshComponent* MeshModule = nullptr;
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	FName IronSightSocketName = TEXT("IronSignSocket");
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="ARES|Weapon|Attachment")
	FName ModuleSocketName = TEXT("ModuleSocket");
...
private:
	UStaticMeshComponent* GetAttachmentMeshComponent(EStoreSubCategory SubCategory) const;
	FName GetDefaultSocketForAttachment(EStoreSubCategory AttachmentSubCategory) const;
	FName GetScopeSocketNameForAttachment(const FItemBaseRow* AttachmentRow) const;
	void ResetScopeSocketIfNeeded();

	void HideAllAttachmentSlotVisuals();
	void SetSlotVisualVisible(UStaticMeshComponent* Comp, bool bVisible) const;
};
